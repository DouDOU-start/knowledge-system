...
type ImportTask struct {
	...
	Status    string      `json:"status"    orm:"status"    description:"任务状态"`      // 任务状态：pending, processing, completed, failed
	...
	Items     string      `json:"items"     orm:"items"     description:"任务项JSON数据"` // 任务项JSON数据
